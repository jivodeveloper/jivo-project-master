...
class _UpdateSalesOrderState extends State<UpdateSalesOrder> {
  ...
  late PartyModel selectedPartyItem;

  var createdBy;
  late CreateOrderRequest createOrderRequest;
  ...
  static List<PartyModel> _party = [];
  bool loading = true;

  void getParties() async {
    try {
      final response =
          await http.get(Uri.parse(Constant.ip_url + "Web/getParties"));
  ...
  // List<OrderItem> item = [];
  final String deleteItemUrl = Constant.ip_url + "Sap/deletePrimaryOrderItem";
  final String primaryUpdateurl = Constant.ip_url+'updatePrimaryOrder';
  ...
  Future<http.Response> createPrimaryUpdateOrder(
    ...
    var response = await http.post(Uri.parse(primaryUpdateurl),
  ...
  final String deletePrimaryOrderUrl = Constant.ip_url + "Sap/deletePrimaryOrderItem";
