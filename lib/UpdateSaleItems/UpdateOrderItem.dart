...
class _UpdateOrderItemState extends State<UpdateOrderItem> {
  ...
  late SchemeItemList selectedSchemeList;
  final myController = TextEditingController();
  late AutoCompleteTextField searchTextField1;
  GlobalKey<AutoCompleteTextFieldState<SchemeItemList>> key = new GlobalKey();
  static List<SchemeItemList> _schemeItem = [];
  bool loading = true;

  void getSchemItemList() async {
    try {
      final response =
          await http.get(Uri.parse( Constant.ip_url + "Sap/GetSchemeItemList"));
  ...
  final String primaryUpdateurl =
      Constant.ip_url + 'Sap/updatePrimaryOrder';
