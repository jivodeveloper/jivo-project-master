...
class _ExpenseReportState extends State<ExpenseReport> {
  ...
  String getExpenseUrl = Constant.ip +"SapExpense/getExpense";

  String grpby="";
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  bool _validate = false;
  List<Expense> glbExpenseList = [];
  final formatter = new NumberFormat("#,###.##");
  //cost api url//
  final String geturl = Constant.ip_url + '/Reports/costReport';
  ...
  Future<List<http.Response>?> getExpenseReport(expenseReport) async {
    ...
    var response = await http.post(Uri.parse(getExpenseUrl),
 ...
 //cost api calling//
  Future<Cost> costReport(String id, String fromdate, String todate) async {
    ...
    List<FullReport> fullReport = report.map<FullReport>((json) => new FullReport.fromJson(json)).toList();
    ...
    debugPrint("total sale ${totalsaleRs.toString()})");
    setState(() {
      ...
      onPressed: () async {
        ...
        if (_formKey.currentState!.validate()) {
          ...
          if (fromDate == "" && toDate == "" && userId != "") {
            ...
            toDate =  DateFormat.yMd().format(todate);
