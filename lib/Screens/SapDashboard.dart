...
class _SapDashboardState extends State<SapDashboard> {
  ...
  final String searchSapRightsUrl = Constant.ip_url + 'Sap/searchSapRights';
  ...
  Future<Null> searchsaprights() async {
    ...
    final response = await http.get(Uri.parse(searchSapRightsUrl));
    final responseJson = json.decode(response.body);
    // var tag = responseJson.map((response)=>SearchSapRights.fromJson(response)).toList();
    setState(() {
      _searchsaprights= responseJson.map((response)=>SearchSapRights.fromJson(response)).toList();
      loading = false;
