...
import '../TransType.dart';

class TranstypeCheck extends StatefulWidget {
  TranstypeCheck(
      {required this.transTypeList, required this.onItemsSelected,required this.onDialogueCancelled});

  final List<TransType> transTypeList;
  final ValueChanged<List<int>> onItemsSelected;
  final List<int> selectedTransTypeIndexes =[];
  final List<int> deSelectedTransTypeIndexes =[];
