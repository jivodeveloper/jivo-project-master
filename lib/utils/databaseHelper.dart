...
class DataBaseHelper {
  ...
  Future<String> readExpense() async {
    ...
    List<Map> list = await newDB.rawQuery("Select SUM(amount) as Total  from ExpenseTable");
    Map<dynamic, dynamic> amountMap = list.first;
  ...
  Future<List<Expense>> dynamicQuery(
    ...
    for (int i = 0; i < dynamicList.length; i++) {
      ...
      Map<dynamic, dynamic> groupMap = dynamicList[i];
